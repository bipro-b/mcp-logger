...
exports.verifyResolutionToolDef = {
    ...
    description: "Re-analyze logs after executing a fix to confirm the issue is resolved. Returns confidence score and remaining issues.",
    inputSchema: {
        type: "object",
...
async function handleVerifyResolution(rawArgs) {
    const args = (rawArgs ?? {});
    ...
    const remaining = result.remaining_issues.length > 0
...
exports.handleVerifyResolution = handleVerifyResolution;
