...
export const executeFixToolDef = {
  name: "execute_fix",
  description:
    "Execute remediation commands from analyze_logs output with security whitelisting. Always preview with dry_run: true first. Commands are validated against a security whitelist — no shell injection possible.",
  inputSchema: {
    type: "object",
    required: ["commands"],
    properties: {
